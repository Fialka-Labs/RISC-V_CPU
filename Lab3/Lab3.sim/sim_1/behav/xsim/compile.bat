...
REM
REM Generated by Vivado on Sun Jun 14 20:55:31 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj lab_05_tb_decoder_vlog.prj"
call xvlog  --incr --relax -L uvm -prj lab_05_tb_decoder_vlog.prj -log xvlog.log
