...
REM
REM Generated by Vivado on Sun Jun 14 21:23:44 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj lab_15_tb_bluster_vlog.prj"
call xvlog  --incr --relax -L uvm -prj lab_15_tb_bluster_vlog.prj -log xvlog.log
