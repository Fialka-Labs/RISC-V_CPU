...
REM
REM Generated by Vivado on Sun Jun 14 21:29:15 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj lab_16_tb_coremark_vlog.prj"
call xvlog  --incr --relax -L uvm -prj lab_16_tb_coremark_vlog.prj -log xvlog.log
