...
REM
REM Generated by Vivado on Sun Jun 14 21:44:21 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj lab_02_tb_alu_vlog.prj"
call xvlog  --incr --relax -L uvm -prj lab_02_tb_alu_vlog.prj -log xvlog.log
